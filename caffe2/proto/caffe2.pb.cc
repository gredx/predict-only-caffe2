...
void protobuf_AssignDesc_caffe2_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AssignDesc_caffe2_2eproto() {
  ...
  static const int QTensorProto_offsets_[8] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(QTensorProto, data_type_),
  };
  ...
  static const int DeviceOption_offsets_[7] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(DeviceOption, extra_info_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(DeviceOption, hip_gpu_id_),
  };
...
void protobuf_AddDesc_caffe2_2eproto() GOOGLE_ATTRIBUTE_COLD;
...
int TensorProto_Segment::RequiredFieldsByteSizeFallback() const {
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_data_type;
        break;
      }
...
int QTensorProto::RequiredFieldsByteSizeFallback() const {
...
// optional .caffe2.TensorProto.DataType data_type = 8 [default = INT32];
bool QTensorProto::has_data_type() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
void QTensorProto::set_has_data_type() {
  _has_bits_[0] |= 0x00000080u;
}
void QTensorProto::clear_has_data_type() {
  _has_bits_[0] &= ~0x00000080u;
}
void QTensorProto::clear_data_type() {
  data_type_ = 2;
  clear_has_data_type();
}
 ::caffe2::TensorProto_DataType QTensorProto::data_type() const {
  // @@protoc_insertion_point(field_get:caffe2.QTensorProto.data_type)
  return static_cast< ::caffe2::TensorProto_DataType >(data_type_);
}
 void QTensorProto::set_data_type(::caffe2::TensorProto_DataType value) {
  assert(::caffe2::TensorProto_DataType_IsValid(value));
  set_has_data_type();
  data_type_ = value;
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 9: {
        ...
        if (input->ExpectTag(74)) goto parse_loop_nets;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectAtEnd()) goto success;
        break;
      }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 5: {
        ...
        if (input->ExpectTag(50)) goto parse_extra_info;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(50)) goto parse_extra_info;
        if (input->ExpectTag(56)) goto parse_hip_gpu_id;
        break;
      }
...
// @@protoc_insertion_point(class_specific_merge_from_start:caffe2.DeviceOption)
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_hip_gpu_id()) {
      set_hip_gpu_id(from.hip_gpu_id());
    }
  }
  if (from._internal_metadata_.have_unknown_fields()) {
    mutable_unknown_fields()->MergeFrom(from.unknown_fields());
...
void DeviceOption::InternalSwap(DeviceOption* other) {
  ...
  extra_info_.UnsafeArenaSwap(&other->extra_info_);
  std::swap(hip_gpu_id_, other->hip_gpu_id_);
  std::swap(_has_bits_[0], other->_has_bits_[0]);
  _internal_metadata_.Swap(&other->_internal_metadata_);
  std::swap(_cached_size_, other->_cached_size_);
}
...
// optional int32 numa_node_id = 5 [default = -1];
bool DeviceOption::has_numa_node_id() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
void DeviceOption::set_has_numa_node_id() {
  _has_bits_[0] |= 0x00000010u;
}
void DeviceOption::clear_has_numa_node_id() {
  _has_bits_[0] &= ~0x00000010u;
}
void DeviceOption::clear_numa_node_id() {
  numa_node_id_ = -1;
  clear_has_numa_node_id();
}
 ::google::protobuf::int32 DeviceOption::numa_node_id() const {
  // @@protoc_insertion_point(field_get:caffe2.DeviceOption.numa_node_id)
  return numa_node_id_;
}
 void DeviceOption::set_numa_node_id(::google::protobuf::int32 value) {
  set_has_numa_node_id();
  numa_node_id_ = value;
...
// optional int32 hip_gpu_id = 7;
bool DeviceOption::has_hip_gpu_id() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
void DeviceOption::set_has_hip_gpu_id() {
  _has_bits_[0] |= 0x00000040u;
}
void DeviceOption::clear_has_hip_gpu_id() {
  _has_bits_[0] &= ~0x00000040u;
}
void DeviceOption::clear_hip_gpu_id() {
  hip_gpu_id_ = 0;
  clear_has_hip_gpu_id();
}
 ::google::protobuf::int32 DeviceOption::hip_gpu_id() const {
  // @@protoc_insertion_point(field_get:caffe2.DeviceOption.hip_gpu_id)
  return hip_gpu_id_;
}
 void DeviceOption::set_hip_gpu_id(::google::protobuf::int32 value) {
  set_has_hip_gpu_id();
  hip_gpu_id_ = value;
...
// optional string debug_info = 10;
bool OperatorDef::has_debug_info() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
void OperatorDef::set_has_debug_info() {
  _has_bits_[0] |= 0x00000200u;
}
void OperatorDef::clear_has_debug_info() {
  _has_bits_[0] &= ~0x00000200u;
}
void OperatorDef::clear_debug_info() {
  debug_info_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_debug_info();
}
 const ::std::string& OperatorDef::debug_info() const {
  // @@protoc_insertion_point(field_get:caffe2.OperatorDef.debug_info)
  return debug_info_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 void OperatorDef::set_debug_info(const ::std::string& value) {
  set_has_debug_info();
 ...
 void OperatorDef::set_debug_info(const char* value) {
  set_has_debug_info();
 ...
 void OperatorDef::set_debug_info(const char* value, size_t size) {
  set_has_debug_info();
 ...
 ::std::string* OperatorDef::mutable_debug_info() {
  set_has_debug_info();
 ...
 ::std::string* OperatorDef::release_debug_info() {
 ...
 void OperatorDef::set_allocated_debug_info(::std::string* debug_info) {
  if (debug_info != NULL) {
    set_has_debug_info();
  } else {
    clear_has_debug_info();
...
void NetDef::SharedCtor() {
  ...
  num_workers_ = 0;
  device_option_ = NULL;
  //device_option_ = new DeviceOption();
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
#define ZR_(first, last) do {\
  ...
  if (_has_bits_[0 / 32] & 249u) {
    ZR_(run_every_ms_, report_interval_);
    if (has_name()) {
      name_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    }
    num_iter_ = GOOGLE_LONGLONG(0);
  ...
  if (_has_bits_[8 / 32] & 7936u) {
    ZR_(concurrent_substeps_, create_workspace_);
...
#define ZR_(first, last) do {\
  ...
  if (_has_bits_[0 / 32] & 127u) {
    ZR_(content_num_chunks_, content_chunk_id_);
    if (has_name()) {
      name_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    }
    if (has_type()) {
...
const ::caffe2::QTensorProto& BlobProto::qtensor() const {
  ...
  return qtensor_ != NULL ? *qtensor_ : *default_instance_->qtensor_;
}
